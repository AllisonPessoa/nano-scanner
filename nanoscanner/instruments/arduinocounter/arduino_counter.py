...
class DigitalCounter(QtWidgets.QWidget, DataHandler, metaclass=FinalMeta):
    def __init__(self, parent=None):
        ...
        file_layout = 'arduino_counter_layout.ui'  # always use slash
        file_layout_path = pkg_resources.resource_filename('instruments.arduinocounter', file_layout)
    ...
    def setDataParams(self, Xdim, Ydim):
        ...
        logger.info("Arduino Digital Counter got data params")
